...
<p><strong>Local:</strong> crie um ficheiro <code>.env</code> na raiz do projeto com <code>ADMIN_SECRET=sua_senha</code> e reinicie o servidor (<code>bun dev</code> ou <code>npm run dev</code>). Depois aceda a <code>/admin/login</code> e use essa senha.</p>
<p><strong>Vercel:</strong> nas Environment Variables do projeto, defina as mesmas chaves:</p>
<p><code>ADMIN_SECRET</code> — senha do admin<br><code>GITHUB_TOKEN</code> — PAT do GitHub<br><code>GITHUB_OWNER</code> — utilizador GitHub<br><code>GITHUB_REPO</code> — nome do repositório</p>
